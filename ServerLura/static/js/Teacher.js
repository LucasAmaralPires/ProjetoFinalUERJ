...
var seeClasses = function(id){
	$.blockUI();
    $.get("/Teacher/getClasses/"+id, function(response){
...
var remove = function(id){
	bootbox.confirm("Do you want to remove this Teacher?<br><br>It will be also deleted from all Classes.", function(response){
		if(response != ""){
			$.blockUI();
